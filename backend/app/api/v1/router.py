...
from app.api.v1 import auth, users, videos, feed, reports, share_analytics, ad_analytics, visitor_analytics
...
api_router.include_router(ad_analytics.router, prefix="/admin/ads", tags=["admin", "ad-analytics"])
