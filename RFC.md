...
- **Swipe-Mechanik:** Rechts = Like, Links = Nicht-Like  
...
- Swipe-Aktion: POST `/videos/{id}/vote` mit direction = like | not_like  
...
* **Frontend:** Nuxt 4 PWA, Mobile-first, vertikaler Feed, Preload für smooth swipe, Overlay „LIKE/NOPE“
* **Backend:** FastAPI, Async REST API, JWT Auth, Video/Feed/Admin Modules, Liked-/Saved-Liste
